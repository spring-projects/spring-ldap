...
You should now be all set to run the examples. If you are running Trifork T4, enter this:

C:\src\ldaptemplate\ldaptemplate-person>trifork archive deploy -inplace -appname
 ldaptemplate default trifork.map

Open a browser and go to http://localhost:8080/ldaptemplate
...
setup_data.ldif
/src/webapp/WEB-INF/ldap.properties
