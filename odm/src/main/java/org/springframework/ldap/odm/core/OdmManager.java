 ...
 * searching operations against an LDAP directory.
 * <p>
...
public interface OdmManager {
	 ...
	 * @param entry The entry to be create, it must <em>not</em> already exist in the
	 * directory.
	 * @throws org.springframework.ldap.NamingException on error.
	 */
	 ...
	 * <p>
	 * Only those entries that both match the given search filter and are represented by
	 ...
	 *
	 * @see <a href=
	 * "https://java.sun.com/products/jndi/tutorial/basics/directory/filter.html">Sun's
	 * JNDI tutorial description of search filters.</a>
	 * @see <a href="https://www.rfc-editor.org/rfc/rfc4515.txt">LDAP: String
	 * Representation of Search Filters RFC.</a>
	 */
