...
link:https://github.com/spring-projects/spring-ldap/actions/workflows/ci.yml[image:https://github.com/spring-projects/spring-ldap/actions/workflows/ci.yml/badge.svg[Build Status]]
...
For detailed information on the project, please refer to the https://docs.spring.io/spring-ldap/docs/current/reference/[reference documentation] and https://docs.spring.io/spring-ldap/reference/api/java/index.html[Javadocs].
See https://github.com/spring-projects/spring-ldap/releases[the changelog] for detailed information on changes in the latest version.

== Code of Conduct
This project adheres to the Contributor Covenant https://github.com/spring-projects/.github/blob/main/CODE_OF_CONDUCT.md[code of conduct].
...
Extensive Javadocs for the Spring LDAP code is also available in the https://docs.spring.io/spring-ldap/reference/api/java/index.html[Spring LDAP API Documentation].
...
That command publishes the docs site to the `_build/site_` directory.
...
== Contributing
https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request[Pull requests] are welcome; see the xref:CONTRIBUTING.adoc[contributor guidelines] for details.
