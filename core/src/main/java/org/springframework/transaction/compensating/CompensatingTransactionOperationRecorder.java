 ...
 * not fail (throwing an Exception), but instead log the result.
 *
...
public interface CompensatingTransactionOperationRecorder {
	 ...
	 * {@link CompensatingTransactionOperationExecutor} to be used if the operation would
	 * need to be rolled back.
	 * @param args The arguments that have been sent to the operation.
