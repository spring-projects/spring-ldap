 ...
 */
@Configuration
public class BaseLdapPathPostProcessorNamespaceTestContext {
    ...
    @Bean("dummyBaseLdapPathAware")
    public DummyBaseLdapPathAware dummyBaseLdapPathAware() {
        return new DummyBaseLdapPathAware();
    }
