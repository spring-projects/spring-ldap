...
=== Support
The community support forum is located at https://forum.spring.io/forum/spring-projects/data/ldap, and the project web page is https://spring.io/spring-ldap/.
...
In this example we will use an https://docs.spring.io/spring-ldap/docs/current/apidocs/org/springframework/ldap/core/AttributesMapper.html[`AttributesMapper`] to easily build a List of all common names of all person objects.
